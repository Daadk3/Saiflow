...
export default function Footer() {
  const linkClass = "text-gray-600 hover:text-gray-900 text-sm font-medium transition-colors";

  return (
    <footer className="bg-gray-50 border-t border-gray-100 py-16 px-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-gray-900">Saiflow</span>
            </Link>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-500 focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                />
        ...
        {/* Bottom row */}
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-gray-100 pt-6">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} Saiflow. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-gray-500">
            <Link href="https://twitter.com" aria-label="Twitter" className="hover:text-gray-900 transition">
            ...
            <Link href="https://facebook.com" aria-label="Facebook" className="hover:text-gray-900 transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M13 10.5V8.75c0-.83.17-1.25 1.36-1.25H15V5h-1.64C10.86 5 10 6.34 10 8.52v2H8v2.5h2V20h3v-7h2.09L15.5 10.5H13z" />
              </svg>
            </Link>
            <Link href="https://instagram.com" aria-label="Instagram" className="hover:text-gray-900 transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Link href="https://linkedin.com" aria-label="LinkedIn" className="hover:text-gray-900 transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
